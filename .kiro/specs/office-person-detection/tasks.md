...
- [x] 2. 設定管理モジュールの実装
  ...
  - 設定値の妥当性検証ロジックを実装（必須項目チェック、型チェック）
...
- [ ] 5. 座標変換とゾーン判定の実装
- [ ] 5.1 CoordinateTransformer クラスを実装
